...
@numba.njit(cache=True)
def _hsv_colorize(rendered, min_sat=0.3, min_val=0.5, hue_shift=None):
...
def colorize(rendered, min_sat=0.3, min_val=0.5, hue_shift=None):
    ...
    '''
    img, hue_shift = _hsv_colorize(rendered, min_sat, min_val, hue_shift)
